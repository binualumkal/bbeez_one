...
class _InstitutionPageState extends State<InstitutionPage> {
  ...
  Future<void> loadInstitutions() async {
    final data = await locate<InstitutionRepository>().getByDomain(
      widget.domainName,
    );

    final unique = <String, InstitutionModel>{};
    ...
    setState(() {
      institutions = unique.values.toList();

      isLoading = false;
    });
  }

  Future<void> addInstitutionDialog() async {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await locate<InstitutionRepository>().saveByName(
                  name: newName,
    ...
    switch (domain.toUpperCase()) {
      case 'FINANCE':
        return {
          ...
          "guideline":
              "Enter your bank, finance company, or investment provider.",
        };
      case 'BUSINESS':
        return {
          ...
          "guideline":
              "Enter your company, vendor, or business service provider.",
        };
      case 'DIGITAL':
        return {
      ...
      case 'PERSONAL':
        return {
          ...
          "guideline":
              "Enter personal records, memberships, IDs, utilities, healthcare providers, or important contacts.",
        };
      default:
        return {
  ...
  Widget buildCard(InstitutionModel item) {
    return Dismissible(
      ...
      onDismissed: (_) async {
        await locate<InstitutionRepository>().delete(item.key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: addInstitutionDialog,
        child: const Icon(
          Icons.add,
          color: Colors.black,
        ),
