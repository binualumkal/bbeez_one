...
class _RecordListPageState extends State<RecordListPage> {
  ...
  Future<void> loadRecords() async {
    final data = await locate<RecordRepository>().getByContext(
  ...
  Widget recordCard(
    ...
    return Container(
      ...
      child: ExpansionTile(
        ...
        title: Text(
          record.fields.isNotEmpty
              ? record.fields.first.label
              : "Record ${index + 1}",
          style: const TextStyle(
            color: Colors.white,
            fontSize: 18,
        ...
        children: [
          ...record.fields.asMap().entries.map(
            (entry) {
              ...
              final v1 = SecurityService.decrypt(field.value);
              final v2 = SecurityService.decrypt(field.value2);
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    if (confirm == true) {
                      ...
                      await locate<RecordRepository>().delete(
                        record.key,
                      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: _getDomainInfo(widget.domainName)["color"],
