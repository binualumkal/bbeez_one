...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> loadSettings() async {
    ...
    final enabled = await settingsRepository.getBiometricEnabled();

    final privacyEnabled = await settingsRepository.getPrivacyScreenEnabled();

    final lockSeconds = AppLockService.instance.timeout.inSeconds;
            ...
            children: [
              ...
              _buildSwitchTile(
                ...
                onChanged: (value) async {
                  ...
                  await locate<SettingsRepository>().setBiometricEnabled(value);
