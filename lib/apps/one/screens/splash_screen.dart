...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _initializeApp() async {
    ...
    final databaseManager = locate<DatabaseManager>();
    ...
    try {
      ...
      final passwordSet = await SecurityService.isPasswordSet();
      ...
      final biometricEnabled = await settingsRepository.getBiometricEnabled();
