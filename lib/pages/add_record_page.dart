...
class AddRecordPage extends StatefulWidget {
  ...
  @override
  State<AddRecordPage> createState() =>
      _AddRecordPageState();
}

class _AddRecordPageState
    extends State<AddRecordPage> {
    ...
    if (widget.existingRecord != null) {
      ...
      for (final field in widget.existingRecord!.fields) {
        ...
        final v1 = TextEditingController(
          text: EncryptionService.decrypt(field.value),
        );
        final v2 = TextEditingController(
          text: EncryptionService.decrypt(field.value2 ?? ""),
        );
  ...
  Future<void> saveRecord() async {
    ...
    i++
      ...
      fields.add(
        SecretField()
          ..label = label
          ..value = EncryptionService.encrypt(val1)
          ..value2 = EncryptionService.encrypt(val2),
      );
    }
  ...
  Widget _buildFieldActions(TextEditingController controller) {
    ...
    return Row(
      ...
      children: [
        ...
        if (isUrl)
          IconButton(
            icon: const Icon(Icons.open_in_new, color: Color(0xFF14F1FF), size: 20),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.calendar_today, color: Color(0xFF14F1FF), size: 20),
            ...
            children: [
              ...
              TextButton(
                      ...
                      return Theme(
                        data: Theme.of(context).copyWith(
                          colorScheme: const ColorScheme.dark(
                            primary: Color(0xFF14F1FF), // Bright Cyan for OK button and highlights
                          ...
                          textButtonTheme: TextButtonThemeData(
                            style: TextButton.styleFrom(
                              foregroundColor: const Color(0xFF14F1FF), // Ensure buttons are bright
                              textStyle: const TextStyle(fontWeight: FontWeight.bold),
                            ),
                          ), dialogTheme: DialogThemeData(backgroundColor: const Color(0xFF061A44)),
                        ),
                        child: child!,
                      );
                    },
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: Color(0xFF14F1FF), fontWeight: FontWeight.bold),
                ),
              ),
            ],
          ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: isSaving
                              ...
                              : Text(
                                  widget.existingRecord == null ? "SAVE" : "UPDATE",
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                  ),
