...
class _ChangePasswordPageState
  ...
  Future<void> _checkBiometric() async {
    final enabled = await DatabaseService.getBiometricEnabled();
  ...
  Future<void> updatePassword() async {
    ...
    if (isBiometricVerified) {
      await DatabaseService.setNewPassword(newPass);
      success = true;
    } else {
      success = await DatabaseService.changePassword(
                        ...
                        Padding(
                          ...
                          child: TextButton.icon(
                            ...
                            style: TextButton.styleFrom(
                              ...
                              side: BorderSide(color: const Color(0xFF14F1FF).withValues(alpha: 0.3)),
                            ),
                            icon: const Icon(Icons.fingerprint, color: Color(0xFF14F1FF)),
                            label: const Text(
                              "VERIFY WITH BIOMETRIC",
                              style: TextStyle(color: Color(0xFF14F1FF), fontWeight: FontWeight.bold),
                            ),
                          ),
                        ),
