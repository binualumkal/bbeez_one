...
class NotificationService {
  ...
  static void _handleNotificationClick(String? payload) async {
    ...
    if (payload.startsWith('record:')) {
      ...
      if (id != null) {
        // Fetch record from Hive box
        final record = DatabaseService.recordBox.get(id);
  ...
  static Future<void> scheduleRecordExpiry(int id, String recordName, DateTime expiryDate) async {
